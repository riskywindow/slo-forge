...
- Physical plan: `physical-plan-27594db07b07719d`
...
- `environment.json` — `803e5a831dc42df9de17f20d9ffb1358dc973fc23c9189733400e9d16c3389d7`
- `topology.json` — `d7e67e922b9da9322db38b36a6ca2d39d69d01135ea0aab29472867d0658bd36`
- `fabric-profile.json` — `a376d58e4b384b5c215349ef6d30cc6c123d837083a8cdcb0cb20faccb7e464e`
...
- `physical-plan.json` — `381668207538adb31388cafb565ab577d233c4d9a1e40026d3675fe81aeec129`
- `physical-plan-topology-unaware.json` — `0bd4465f7461ddbf1763ac964df9ea66015177e118aa7fdaeb6d78750414972d`
- `optimizer.json` — `b884ae620f755224db8b47daad271a0c10f78b3f9a3c516ca10c09c7212a3b86`
- `mixed-bursty.jsonl` — `289d8b8c9d50a829aa2a72e9b4b2815563858686b9503bac0ac845aaa84c4064`
- `simulations/healthy-request.json` — `89719999a53ec27bcfd610b48ffc5740f11e303c8693f0825ba174f2f38dca3f`
- `simulations/degraded-request.json` — `dae6aab25b2fedb1b89ad43e8fad8781b6539989edb8a929f68a7bb29b989789`
- `simulations/restored-request.json` — `052ab982ab6cfa54fd3c02263f033a2c5435871be2b847a66289b9c0aade17f9`
- `simulations/healthy.json` — `97b3bab79e7a99ad479492335b4043fe897f6fa35052c9e7bbd2cb3e7e96291a`
- `simulations/degraded.json` — `ac1410d384c75add63d6aa3ce28762e7f3e034ca22e018917fef821e149a76d2`
- `simulations/restored.json` — `7aaa5f502cfb92cd858493e7851b9e1d99296a86517ba989470b8ee5a620493e`
- `autopsy/healthy-run.json` — `c865a7d93d124783e2f7c12f913fa80ae03aeb2e7d6183d0800d9c68ad6871f9`
- `autopsy/degraded-run.json` — `8ba97884b08864e7bdf11cf67b9ea470017e29f8b727381c5dea3a2e0d357c29`
- `autopsy/comparison.json` — `ae54dc48a75305be2c66cedd9d14dc9d362f77814a50defd2af157bbfdce2c6b`
- `autopsy/diagnosis.json` — `a91b44b619cd4630cc92b4a40df9fc13022bcb1fd6eae31c054ae4e5deb282fe`
- `autopsy/counterfactuals.json` — `6009c8e026c875b2d7bed0d98483914f15b63aa0339cb8a3ca603a21c7de3c3b`
- `autopsy/scenarios.json` — `7ab93d17274e810f5377e1a599b1c13209b407ed3d971081832425f2274023bb`
- `autopsy/replay-metadata.json` — `20490590c40110b6a66397cdd081f6953e90c374dae838c051308fee906d7a17`
- `recovery/proposal.json` — `6595c8cbfd333e6e16d7ae875fabfaf43dd86583b4ed48bd952c87823cd4731f`
- `recovery/execution.json` — `6bff5b5b6da4955f23752804d530dd6c9821602d26af46da0f9bb3c3a1148809`
- `traces/degraded.perfetto.json` — `7f18bf6083eaa68d3292559511ba7cd175f98f9a063d6430faab8c0f062b9b77`
- `traces/otel.json` — `01f9165b4caa2ae1731effaa3100ad88ca53300571ed3b20eb71b6a94b6acef2`
- `metrics/healthy.prom` — `7734fc6728093bffcf834cce590f5ece00aa900e66f9eedfb71d8a67e2183a69`
- `metrics/degraded.prom` — `68791282f76e4c9f3d630d76ee89bce16a33a7c4f0bb70f6a3c94c3c840cd34f`
- `metrics/restored.prom` — `77e3c9f0b8b800443020cbc75163115e5767df64e1e3c9c38291fa70ab61ff54`
- `timeline.json` — `d49f6664db9acff5f5157b5340701681e173bf87dd2075410d62b2f076fe75e9`
- `runtime/gateway-replay.json` — `220a01c976ab25972182f860646fab897867f1c14be877118d558920f33e12a1`
- `runtime/gateway.prom` — `7db05914c7b5d6ad38bf29fd0d62a66f8859cf98421a311c0874f874d299a22d`
- `runtime/gateway.perfetto.json` — `16b4884b8ef0a6924ae706c74747b77ece7e40869d00ce9b5ef27317d9f11693`
- `fabric-profile-raw/profile.json` — `1318f57ee7e8ee621d598461a51e1105365c545e9789689babc3e972d7c94aac`
...
- `runtime/fabric-backend-0.json` — `88b0afb181bcb3a3b72611e12e9feb1b7b779592156639061aebd72b7235ba84`
- `runtime/fabric-backend-1.json` — `a15bc9145654ba9a75ba87efa54ee04c5039628798e5867ff42995fd58b1be99`
- `runtime/gateway.json` — `0a1a9faa8466c338b1520a88627f7efd30f69447bd5bf4d56cd826e1f0192b20`
- `runtime/logs/fabric-backend-0.stderr.log` — `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`
- `runtime/logs/fabric-backend-0.stdout.log` — `14a5a8edbb807f4d16250fcbf9eddec954f87964b436856c7fe6f2f6f03b241e`
- `runtime/logs/fabric-backend-1.stderr.log` — `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`
- `runtime/logs/fabric-backend-1.stdout.log` — `dc8f46a5ac0054c085f9036ec20ba9c2ff34d66e421d048b455526dfc86cf4da`
- `runtime/logs/fabric-gateway.stderr.log` — `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`
- `runtime/logs/fabric-gateway.stdout.log` — `c0a7d81345a9b8f90046d07368bb2009828f57c140d57ba2c84a48bc3252a0f2`
